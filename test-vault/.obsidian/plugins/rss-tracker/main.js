...
function toFilename(name) {
  let fname = name.replace(/\w+:\/\/.*/, "").replaceAll("?", "\u2753").replaceAll(".", "\u2024").replaceAll(":", "\uA789").replaceAll('"', "\u2033").replaceAll('<"', "\uFF1C").replaceAll('>"', "\uFF1E").replaceAll('|"', "\u2223").replaceAll("\\", "/").replaceAll("/", "\u2571").replaceAll("[", "{").replaceAll("]", "}").replaceAll("#", "\uFF03").replaceAll("^", "\u25B3").replaceAll("&", "+").replaceAll("*", "\u2731");
  if (fname.length > 80) {
...
FeedManager.HASH_FINDER = /(?<!\]\([^\s]*|\[\[[^\]]*|[\w&/])#(?=\w)/g;
