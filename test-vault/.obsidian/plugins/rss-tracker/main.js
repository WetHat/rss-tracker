...
var _DataViewJSTools = class {
  ...
  rssItemsOfContext(context) {
    ...
    switch (ctx.role) {
      case "rssfeed":
        ...
        break;
      case "rsscollection":
        pages = this.dv.pages(this.fromItemsOfCollection(ctx)).where((p) => p.role === "rssitem");
        break;
      case "rsstopic":
  ...
  */
   ...
   */
  async expandableTable(header, rows, label = "Files", expand = false) {
    if (expand === void 0) {
